...
Under the "Advanced" options, set an environment variable called `APP_KEY` (specifying your own API Key value, without quotes). Also set an environment called `SECRET_PASSWORD` and specify your own unique value.
